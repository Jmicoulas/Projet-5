...
**********************************************/
	...
	async function allProductsList(){
		...
		produits.forEach((produit) =>
		{
      	...
      	produitBlock.setAttribute("class", "card w-75 h-75 my-4 pt-5 mx-auto");
      	produitRight.setAttribute("class", "card-body");
      	produitImage.setAttribute("src", produit.imageUrl);
        produitImage.setAttribute("class","card-img-top  mx-auto d-block");
      	produitImage.setAttribute("alt", "image du produit");
      	produitLink.setAttribute("href", "product.html?id=" + produit._id);
        produitLink.setAttribute("class", "btn btn-outline-danger");

     	//Block conteneur en card
     	...
     	produitRight.appendChild(produitLink);
      	...
      	produitLink.textContent = "Voir les détails du produit";
      });
	};
